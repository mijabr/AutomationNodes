...
//        {
//            public MyScene(IWorld world) : base(world)
//            {
//            }

//            public string TheScript { get; set; }
//            public override string Script => TheScript;
//        }

//        private class TestState
//        {
//            public MyScene Scene { get; }
...
//                Scene = new MyScene(World.Object);
//            }
//        }
...
//        {
//            var state = new TestState();
//            state.Scene.TheScript = "Div(1).set({position:absolute,left:100px,top:100px})";
...
//        {
//            var state = new TestState();
//            state.Scene.TheScript = "Div(1).set({position:absolute,left:100px,top:100px}).transition({left:0px,top:0px,duration:1000})";
